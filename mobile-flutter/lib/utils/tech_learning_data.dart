class TechLearningRepository {
  static const List<Map<String, String>> categories = [
    {'id': 'All', 'title': 'All 54 Techs', 'icon': '🚀'},
    {'id': 'Web Development', 'title': 'Web Development', 'icon': '🌐'},
    {'id': 'Languages', 'title': 'Languages', 'icon': '💻'},
    {'id': 'Databases', 'title': 'Databases', 'icon': '📊'},
    {'id': 'Mobile', 'title': 'Mobile', 'icon': '📱'},
    {'id': 'AI & Cloud', 'title': 'AI & Cloud', 'icon': '☁️'},
    {'id': 'DevOps & OS', 'title': 'DevOps & OS', 'icon': '🐳'},
    {'id': 'Security & Web3', 'title': 'Security & Web3', 'icon': '🛡️'},
    {'id': 'Software Eng & Practice', 'title': 'Software Eng & Practice', 'icon': '📐'},
  ];

  static const List<Map<String, String>> technologies = [
  ...
  static Map<String, dynamic> getChannels(String techId) {
    const defaultEn = {"name": "freeCodeCamp", "channel": "https://www.youtube.com/@freecodecamp"};
    const defaultTe = {"name": "Telugu Web Guru", "channel": "https://www.youtube.com/@teluguwebguru"};

    final Map<String, Map<String, dynamic>> custom = {
      'html': {'en': {'name': 'Traversy Media', 'channel': 'https://www.youtube.com/@TraversyMedia'}, 'te': {'name': 'Telugu Web Guru', 'channel': 'https://www.youtube.com/@teluguwebguru'}},
      'css': {'en': {'name': 'Kevin Powell', 'channel': 'https://www.youtube.com/@KevinPowell'}, 'te': {'name': 'Telugu Web Guru', 'channel': 'https://www.youtube.com/@teluguwebguru'}},
      'javascript': {'en': {'name': 'SuperSimpleDev', 'channel': 'https://www.youtube.com/@SuperSimpleDev'}, 'te': {'name': 'Telugu Web Guru', 'channel': 'https://www.youtube.com/@teluguwebguru'}},
      'react': {'en': {'name': 'Codevolution', 'channel': 'https://www.youtube.com/@Codevolution'}, 'te': {'name': 'Mass Coders', 'channel': 'https://www.youtube.com/@niharrdg'}},
      'python': {'en': {'name': 'Corey Schafer', 'channel': 'https://www.youtube.com/@coreyms'}, 'te': {'name': 'Amarnadh Talks', 'channel': 'https://www.youtube.com/@AmarnadhTalks'}},
      'java': {'en': {'name': 'Telusko', 'channel': 'https://www.youtube.com/@Telusko'}, 'te': {'name': 'VLR Training', 'channel': 'https://www.youtube.com/@VlrTraining'}},
      'flutter': {'en': {'name': 'Flutter Official', 'channel': 'https://www.youtube.com/@flutterdev'}, 'te': {'name': 'Telugu Tech Tutorials', 'channel': 'https://www.youtube.com/@TeluguTechTutorials'}},
      'dsa': {'en': {'name': 'Striver (Take U Forward)', 'channel': 'https://www.youtube.com/@takeUforward'}, 'te': {'name': 'Telugu Coding Community', 'channel': 'https://www.youtube.com/@TeluguCodingCommunity'}},
      'docker': {'en': {'name': 'TechWorld with Nana', 'channel': 'https://www.youtube.com/@TechWorldwithNana'}, 'te': {'name': 'DevOps in Telugu', 'channel': 'https://www.youtube.com/@devopsintelugu'}},
      'aws': {'en': {'name': 'Stephane Maarek', 'channel': 'https://www.youtube.com/@StephaneMaarek'}, 'te': {'name': 'AWS in Telugu', 'channel': 'https://www.youtube.com/@awsintelugu'}},
    };

    return custom[techId] ?? {'en': defaultEn, 'te': defaultTe};
  }
}
